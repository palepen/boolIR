#ifndef DYNAMIC_RETRIEVER_H
#define DYNAMIC_RETRIEVER_H
...
// Re-defining DiskLocation here as its old header was deleted
struct DiskLocation {
    long long offset;
    size_t size;
};
...
class DynamicParallelRetriever {
public:
    DynamicParallelRetriever(const std::string& index_path, size_t num_shards);
