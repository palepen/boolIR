...
WordPieceTokenizer::WordPieceTokenizer(
    ...
    const std::string &unk_token) : max_input_chars_per_word_(max_input_chars_per_word),
...
bool WordPieceTokenizer::is_punctuation(char c) const
{
...
{
    if (word.length() > static_cast<size_t>(max_input_chars_per_word_))
    {
        return {unk_token_};
    }
